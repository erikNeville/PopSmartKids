                    ...
                    <div class="row justify-content-md-center text-center">
                        ...
                        <div class="col-md-2 mb-3">
                            <h6 class="text-uppercase font-weight-bold">
                                <a class="footer-info" href="http://smart2.icoolshow.net/privacyPolicy.html">Privacy Policy</a>
                            </h6>
                        </div>
                        <div class="col-md-2 mb-3">
                            <h6 class="text-uppercase font-weight-bold">
                                <a class="footer-info" href="http://smart2.icoolshow.net/legal.html">Terms of Use</a>
                            </h6>
                        </div>
                        <div class="col-md-2 mb-3">
                            <h6 class="text-uppercase font-weight-bold">
                                <a class="footer-info" href="http://smart2.icoolshow.net/safeZone.html">safe zone</a>
                            </h6>
                        </div>
