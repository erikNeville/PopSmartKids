...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$res['success']) {
        ...
        echo "<script>setTimeout(\"location.href = 'http://smart2.icoolshow.net/contactUs.html';\",2500);</script>";
	...
	$from='From: '. $email . "(" . $FirstName . $LastName. ")" . "\r\n" . 'Bcc: ' . "\r\n";
	// sends bcc to alternate address 

	//Creates intelligible subject line that shows where it came from
	$subject = 'Email from the CONTACT US form'; // if your client has more than one web site, you can put the site name here.
	 ...
	 ****/
	mail ('popsmarkids2@gmail.com', $subject, $body, $from);
